<%@ Page Title="" Language="C#" MasterPageFile="~/diary/Diary.Master" AutoEventWireup="true" CodeBehind="writediary.aspx.cs" Inherits="WebApplication1.diary.writediary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<hr /> 
	<button class="btn btn-primary" type="submit" OnServerClick="WriteClick" runat="server">Write</button>
